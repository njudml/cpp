...
#include "../inc/cppjieba/KeywordExtractor.hpp"
#include "jenkins.h"
...
public:
    Simhasher()
        : _extractor("../data/dict/jieba.dict.utf8", "../data/dict/hmm_model.utf8", "../data/dict/idf.utf8", "../data/dict/stop_words.utf8")
    {
    }
    ~Simhasher(){};

    void extract(const string& text, vector<pair<string, double>>& res, size_t topN) const
    {
